      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <form action="/editleaveAction/{{$value->id}}" method="post" autocomplete="off">
                @csrf
             
                <!-- <div class="card-body"> -->
                  <div class="form-group">
                    <label for="serialno">Serial No</label>
                    <input type="text" class="form-control"  name="serialno" id="serialno" value="{{$value->serialno}}" placeholder="Enter serialno">
                  </div>
                  <div class="form-group">
                    <label for="leavetype">Leave type</label>
                    <input type="text" class="form-control" name="leavetype" id="leavetype" value="{{$value->leavetype}}" placeholder="leavetype">
                  </div>
