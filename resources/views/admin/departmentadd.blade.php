        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="/deptaddAction" method="post" autocomplete="off">
                  @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Dept ID</label>
                    <input type="text" class="form-control"  name="deptid" id="deptid" placeholder="Enter deptid">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Department Name</label>
                    <input type="text" class="form-control" name="departmentname" id="departmentname" placeholder="Dept.name">
                  </div>
                  <!-- <div class="form-group">
