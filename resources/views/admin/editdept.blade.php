      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/addleave" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Leave Add</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="/leaveview" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>view Leave</p>
                </a>
              </li> 
              ...
              <li class="nav-item">
                <a href="/deptview" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>view Department</p>
                </a>
              </li>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/admintable" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Employee Info</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/userleaveview" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <form action="/editdeptAction/{{$value->id}}" method="post" autocomplete="off">
                  @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Dept ID</label>
                    <input type="text" class="form-control"  name="deptid" id="deptid" value="{{$value->deptid}}" placeholder="Enter deptid">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Department Name</label>
                    <input type="text" class="form-control" name="departmentname" id="departmentname" value="{{$value->departmentname}}" placeholder="Dept.name">
                  </div>
                  <!-- <div class="form-group">
